...
@implementation HLSLocalization
...
+ (NSString *)stringForKey:(NSString *)key
{
    return [[HLSLocalization sharedInstance] stringForKey:key];
}

+ (NSString *)stringForKey:(NSString *)key withInt:(int)num
{
    NSString *str = [[[HLSLocalization sharedInstance] stringForKey:key] stringByReplacingOccurrencesOfString:@"*" withString:[NSString stringWithFormat:@"%d",num]];

    if([[[HLSLocalization sharedInstance] getLanguage] isEqualToString:@"ar"]){
...
{
    NSString *str = [[[HLSLocalization sharedInstance] stringForKey:key] stringByReplacingOccurrencesOfString:@"*" withString:[NSString stringWithFormat:@"%ld",num]];
